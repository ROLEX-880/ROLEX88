...
def main():
	...
	print("\033[1;92m\t│\033[1;92mWELLCOME TO ROLEX 2.8     \033[1;92m      │")
	...
	if Adi in ('0', '00'):
		...
		exit('THANKS FOR USING ROLEX TOOL')  
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mROLEX\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Idz\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				print('\r\033[1;37m[\033[1;32mROLEX-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
	...
	def __pler__(self):
		...
		if yan == '':
			...
			print('\033[1;37m[+]\033[1;36mAHSAm PROCESS HAS BEEN STARTED')
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				open('ROLEX_Ok.txt','a').write('%s\n' % wrt)

				break

			elif 'checkpoint' in ses.cookies.get_dict():

				print('\r\033[1;37m[\033[1;31mROLEX-CP\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
...
d8888b.  .d88b.  db      d88888b db    db 

88  `8D .8P  Y8. 88      88'     `8b  d8' 

88oobY' 88    88 88      88ooooo  `8bd8'  

88`8b   88    88 88      88~~~~~  .dPYb.  

88 `88. `8b  d8' 88booo. 88.     .8P  Y8. 

88   YD  `Y88P'  Y88888P Y88888P YP    YP 

                                                                        

=================================================

    [-] AUTHOR    :\033[1;32m RIFAT

    [-] GITHUB    :\033[1;32m ROLEX-880

    [-] WhatsApp  :\033[1;32m 01890384480
